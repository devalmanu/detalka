...
<ul>
	...
	<li>подобный случай сделан в дизайне в на 3 шаге  "Способ оплаты", по такой же логике переключения и вывода како-либо подробной информации по оплате ниже при смене оплат можно создать уже на этапе программирования (опираясь на 2 пункт шага)</li>
